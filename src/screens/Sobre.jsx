...
export const Sobre = ({  RootNavigation }) => (
    <View>
        <Text style={styles.texto}>O tema escolhido foi a Livrarias Curitibas, ela foi fundada de um sonho do comerciante Valentim Pedri que era um ex-funcionário de uma editora nos anos 50.
